...
<section id="events" class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="flex justify-between items-end mb-12">
        ...
        <div class="flex flex-wrap gap-3 justify-center">
            ...
            <a href="/?category={{ $cat->slug }}" class="px-6 py-2.5 {{ request('category') == $cat->slug ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-200' : 'bg-white text-slate-600 border border-slate-200' }} hover:bg-indigo-600 hover:text-white rounded-xl font-bold transition-all duration-300">
                {{ $cat->name }}
            </a>
            @endforeach
        </div>
