...
<div class="max-w-3xl mx-auto px-6 py-12 mt-8">
    <div class="mb-8">
        ...
        <p class="text-slate-500 mt-1">Masukkan detail acara yang akan kamu selenggarakan.</p>
    </div>
        ...
        <form action="{{ route('organizer.events.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-1">Isi 0 kalau event ini gratis (nanti otomatis bypass Midtrans).</p>
                </div>
                <div>
